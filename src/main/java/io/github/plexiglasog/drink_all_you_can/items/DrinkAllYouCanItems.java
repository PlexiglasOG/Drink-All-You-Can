...
public class DrinkAllYouCanItems {
    ...
    public static final Item RED_COW_CAN = register("red_cow_can",
            ...
            new Item.Settings().food(ZERO_NUTRITION_ALWAYS_EDIBLE_FOODCOMPONENT,
                    ConsumableComponents.food()
                            ...
                            .consumeEffect(new ApplyEffectsConsumeEffect(new StatusEffectInstance(DrinkAllYouCanEffects.RED_COW_ENERGY_EFFECT, 20 * 30, 0), 1.0F))
                            .build()
            )
    );
    //Effectless Variant
...
//                            .consumeEffect(new ApplyEffectsConsumeEffect(new StatusEffectInstance(StatusEffects.SPEED, 20*5, 2),1.0F))
                            .consumeEffect(new ApplyEffectsConsumeEffect(new StatusEffectInstance(DrinkAllYouCanEffects.SMOKER_COLA_EFFECT, 20 * 61, 0), 1.0F))
                            .build()
            )
    );
    //Effectless Variant
    ...
    public static Item register(String path, Function<Item.Settings, Item> factory, Item.Settings settings) {
        final RegistryKey<Item> registryKey = RegistryKey.of(RegistryKeys.ITEM, Identifier.of(DrinkAllYouCan.MOD_ID, path));
